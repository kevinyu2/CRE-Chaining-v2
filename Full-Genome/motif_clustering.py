...
# PSSM for the clusters, for pre-clustered
CLUSTERED_MEME_OUT = '/home/mwarr/Data/DAPv1_clustered.meme'

# A file detailing the clusters, for post-clustered
CLUSTERS_OUT = '/home/mwarr/Data/DAPv1_clusters.txt'

# Heirarchical clustering threshold
CLUSTER_THRESH = 0.4
...
write_multiple_pssms_to_meme_file(pssm_out_dict, CLUSTERED_OUT)
